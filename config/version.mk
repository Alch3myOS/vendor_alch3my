...
ALCH3MY_VERSION := beta
ALCH3MY_BUILD_TYPE ?= UNOFFICIAL
ALCH3MY_BUILD_VARIANT := GMS
LINEAGE_BUILD := $(DEVICE_CODENAME)

# Internal version
LINEAGE_VERSION := Alch3myOS-$(ALCH3MY_VERSION)-$(LINEAGE_BUILD)-$(ALCH3MY_BUILD_TYPE)-$(shell date -u +%Y%m%d)

# Display version
LINEAGE_DISPLAY_VERSION := $(ALCH3MY_VERSION)-$(shell date -u +%Y%m%d)
