...
else ifeq ($(TARGET_DEVICE),cheetah)
    PIF_PRODUCT := cheetah
    PIF_MODEL := "Pixel 7 Pro"
    PIF_INC := 14401865
    TARGET_PIF_ID := $(PIF_ID_0)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_0)
else ifeq ($(TARGET_DEVICE),lynx)
    PIF_PRODUCT := lynx
    PIF_MODEL := "Pixel 7a"
    PIF_INC := 14624666
    TARGET_PIF_ID := $(PIF_ID_0)
...
# --- 9 Series ---
else ifeq ($(TARGET_DEVICE),tokay)
    PIF_PRODUCT := tokay
    PIF_MODEL := "Pixel 9"
    PIF_INC := 14624737
    TARGET_PIF_ID := $(PIF_ID_2)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_1)
else ifeq ($(TARGET_DEVICE),caiman)
    PIF_PRODUCT := caiman
    PIF_MODEL := "Pixel 9 Pro"
    PIF_INC := 14624737
    TARGET_PIF_ID := $(PIF_ID_2)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_1)
else ifeq ($(TARGET_DEVICE),komodo)
    PIF_PRODUCT := komodo
    PIF_MODEL := "Pixel 9 Pro XL"
    PIF_INC := 14624737
    TARGET_PIF_ID := $(PIF_ID_2)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_1)
else ifeq ($(TARGET_DEVICE),tegu)
    PIF_PRODUCT := tegu
    PIF_MODEL := "Pixel 9a"
    PIF_INC := 14624666
    TARGET_PIF_ID := $(PIF_ID_1)
...
# --- 10 Series ---
else ifeq ($(TARGET_DEVICE),frankel)
    PIF_PRODUCT := frankel
    PIF_MODEL := "Pixel 10"
    PIF_INC := 14624666
    TARGET_PIF_ID := $(PIF_ID_1)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_1)
else ifeq ($(TARGET_DEVICE),blazer)
    PIF_PRODUCT := blazer
    PIF_MODEL := "Pixel 10 Pro"
    PIF_INC := 14624666
    TARGET_PIF_ID := $(PIF_ID_1)
    TARGET_PIF_SECURITY_PATCH := $(PIF_SECURITY_PATCH_1)
else ifeq ($(TARGET_DEVICE),mustang)
    PIF_PRODUCT := mustang
